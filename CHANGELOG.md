...
- Make the top border the collapse control for an expanded box: hovering the top edge fades in a merge icon on the line, and clicking the line folds that one box back in place.
